...
impl EntityReference for crate::GoalCategory {
...
#[derive(Debug)]
pub struct GoalCategoryRequest<R = crate::GoalCategory> {
    query: SelectQuery,
...
impl<R> Clone for GoalCategoryRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> GoalCategoryRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("GoalCategory"),
    ...
    pub fn return_type<T>(self) -> GoalCategoryRequest<T> {
        GoalCategoryRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
        let repository = ctx
            .goal_category_repository()
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| RepositoryError::Runtime(RuntimeError::Graph(format!("count result for GoalCategory is missing or not numeric"))))
    }

    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_normal(self) -> Self {
        self.with_name_is("Normal")
    }

    pub fn with_name_is_normal(self) -> Self {
        self.with_name_is("Normal")
    }



    pub fn with_name_is_not_normal(self) -> Self {
        self.with_name_is_not("Normal")
    }


    pub fn name_is_penalty(self) -> Self {
        self.with_name_is("Penalty")
    }

    pub fn with_name_is_penalty(self) -> Self {
        self.with_name_is("Penalty")
    }



    pub fn with_name_is_not_penalty(self) -> Self {
        self.with_name_is_not("Penalty")
    }


    pub fn name_is_own_goal(self) -> Self {
        self.with_name_is("Own Goal")
    }

    pub fn with_name_is_own_goal(self) -> Self {
        self.with_name_is("Own Goal")
    }



    pub fn with_name_is_not_own_goal(self) -> Self {
        self.with_name_is_not("Own Goal")
    }


    pub fn name_is_free_kick(self) -> Self {
        self.with_name_is("Free Kick")
    }

    pub fn with_name_is_free_kick(self) -> Self {
        self.with_name_is("Free Kick")
    }



    pub fn with_name_is_not_free_kick(self) -> Self {
        self.with_name_is_not("Free Kick")
    }



    pub fn code_is_norma_l(self) -> Self {
        self.with_code_is("NORMAL")
    }

    pub fn with_code_is_norma_l(self) -> Self {
        self.with_code_is("NORMAL")
    }



    pub fn with_code_is_not_norma_l(self) -> Self {
        self.with_code_is_not("NORMAL")
    }


    pub fn code_is_penalt_y(self) -> Self {
        self.with_code_is("PENALTY")
    }

    pub fn with_code_is_penalt_y(self) -> Self {
        self.with_code_is("PENALTY")
    }



    pub fn with_code_is_not_penalt_y(self) -> Self {
        self.with_code_is_not("PENALTY")
    }


    pub fn code_is_own_goa_l(self) -> Self {
        self.with_code_is("OWN_GOAL")
    }

    pub fn with_code_is_own_goa_l(self) -> Self {
        self.with_code_is("OWN_GOAL")
    }



    pub fn with_code_is_not_own_goa_l(self) -> Self {
        self.with_code_is_not("OWN_GOAL")
    }


    pub fn code_is_free_kic_k(self) -> Self {
        self.with_code_is("FREE_KICK")
    }

    pub fn with_code_is_free_kic_k(self) -> Self {
        self.with_code_is("FREE_KICK")
    }



    pub fn with_code_is_not_free_kic_k(self) -> Self {
        self.with_code_is_not("FREE_KICK")
    }
...
impl<R> Default for GoalCategoryRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< GoalCategoryRequest<R> > for SelectQuery {
    fn from(request: GoalCategoryRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< GoalCategoryRequest<R> > for QuerySelection {
    fn from(request: GoalCategoryRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::GoalCategory> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>;
    fn save(self, ctx: &'a C) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<teaql_runtime::GraphNode, Self::Error>> + '_>> {
        Box::pin(async move { self.into_entity().save(ctx).await })
    }
}

impl<R: teaql_core::Entity> crate::PurposedQuery<GoalCategoryRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::GoalCategory
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::GoalCategory::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> GoalCategoryRequest<R> {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
