...
#[teaql(entity = "MatchStatus", table = "match_status_data", data_service = "sqlite")]
...
#[teaql(relation(target = "TournamentMatch", local_key = "id", foreign_key = "match_status_id", many))]
...
impl MatchStatus {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("MatchStatus", self.id)
    }
    ...
    pub(crate) async fn save<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<teaql_runtime::GraphNode, crate::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
