...
#[teaql(relation(target = "CardCategory", local_key = "card_category_id", foreign_key = "id"))]
    card_category: Option<crate::CardCategory>,
...
impl MatchCard {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("MatchCard", self.id)
    }
    ...
    pub fn minute_issued(&self) -> i32 {
        self.changed_minute_issued().and_then(|value| value.try_i64()).map(|value| value as i32).unwrap_or(self.minute_issued)
    }

    pub fn update_minute_issued(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.minute_issued = value.try_i64().map(|value| value as i32).unwrap_or(self.minute_issued.clone());
        self.root.set(self.entity_key(), "minute_issued", value);
        self
    }

    pub fn changed_minute_issued(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "minute_issued")
    }

    pub fn eval_minute_issued(&self) -> teaql_core::eval::EvalResult<i32> {
    ...
    pub(crate) fn update_card_category_id(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        ...
        self.root.set(self.entity_key(), "card_category_id", value);
        self
    }

    pub fn changed_card_category_id(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "card_category_id")
    }
    ...
    pub fn card_category(&self) -> Option<&crate::CardCategory> {
        self.card_category.as_ref()
    }

    pub fn eval_card_category(&self) -> teaql_core::eval::EvalResult<&crate::CardCategory> {
        if !self.is_loaded("card_category") {
            teaql_core::eval::EvalResult::NotLoaded { failed_node: "card_category".to_string(), attempted_path: "card_category".to_string() }
        } else {
