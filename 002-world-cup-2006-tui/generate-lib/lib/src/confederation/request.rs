...
impl EntityReference for crate::Confederation {
...
#[derive(Debug)]
pub struct ConfederationRequest<R = crate::Confederation> {
    query: SelectQuery,
...
impl<R> Clone for ConfederationRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> ConfederationRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Confederation"),
    ...
    pub fn return_type<T>(self) -> ConfederationRequest<T> {
        ConfederationRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| RepositoryError::Runtime(RuntimeError::Graph(format!("count result for Confederation is missing or not numeric"))))
    }

    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn with_name_is_not_af_c(self) -> Self {
    ...
    pub fn with_name_is_not_ca_f(self) -> Self {
        self.with_name_is_not("CAF")
    }
    ...
    pub fn with_name_is_not_concaca_f(self) -> Self {
    ...
    pub fn with_name_is_not_conmebo_l(self) -> Self {
        self.with_name_is_not("CONMEBOL")
    }
    ...
    pub fn with_name_is_not_of_c(self) -> Self {
    ...
    pub fn with_name_is_not_uef_a(self) -> Self {
        self.with_name_is_not("UEFA")
    }
    ...
    pub fn with_code_is_not_af_c(self) -> Self {
    ...
    pub fn with_code_is_not_ca_f(self) -> Self {
        self.with_code_is_not("CAF")
    }
    ...
    pub fn with_code_is_not_concaca_f(self) -> Self {
    ...
    pub fn with_code_is_not_conmebo_l(self) -> Self {
        self.with_code_is_not("CONMEBOL")
    }
    ...
    pub fn with_code_is_not_of_c(self) -> Self {
    ...
    pub fn with_code_is_not_uef_a(self) -> Self {
        self.with_code_is_not("UEFA")
    }
...
impl<R> Default for ConfederationRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< ConfederationRequest<R> > for SelectQuery {
    fn from(request: ConfederationRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< ConfederationRequest<R> > for QuerySelection {
    fn from(request: ConfederationRequest<R>) -> Self {
        Self {
            query: request.query,
...
{
    type Error = crate::TeaqlRepositoryError<C::ConfederationRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<ConfederationRequest<R>> {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
