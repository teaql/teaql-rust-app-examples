...
#[teaql(entity = "Confederation", table = "confederation_data", data_service = "sqlite")]
pub struct Confederation {
// @source model.xml:103
#[teaql(id)]
    id: u64,
...
#[teaql(relation(target = "TournamentTeam", local_key = "id", foreign_key = "confederation_id", many))]
...
impl Confederation {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("Confederation", self.id)
    }
    ...
    pub fn eval_tournament_team_list(&self) -> teaql_core::eval::EvalResult<&SmartList<crate::TournamentTeam>> {
        if !self.is_loaded("tournament_team_list") {
            ...
            teaql_core::eval::EvalResult::Value(&self.tournament_team_list)
        }
    }
    ...
    pub(crate) async fn save<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<teaql_runtime::GraphNode, crate::TeaqlRepositoryError<C::ConfederationRepository<'a>>>
    where
