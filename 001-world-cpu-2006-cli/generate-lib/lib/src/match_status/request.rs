...
impl EntityReference for crate::MatchStatus {
...
#[derive(Debug)]
pub struct MatchStatusRequest<R = crate::MatchStatus> {
    query: SelectQuery,
...
impl<R> Clone for MatchStatusRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> MatchStatusRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("MatchStatus"),
    ...
    pub fn return_type<T>(self) -> MatchStatusRequest<T> {
        MatchStatusRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| RepositoryError::Runtime(RuntimeError::Graph(format!("count result for MatchStatus is missing or not numeric"))))
    }

    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_live(self) -> Self {
        self.with_name_is("Live")
    }

    pub fn with_name_is_live(self) -> Self {
        self.with_name_is("Live")
    }



    pub fn with_name_is_not_live(self) -> Self {
        self.with_name_is_not("Live")
    }


    pub fn name_is_finished(self) -> Self {
        self.with_name_is("Finished")
    }

    pub fn with_name_is_finished(self) -> Self {
        self.with_name_is("Finished")
    }



    pub fn with_name_is_not_finished(self) -> Self {
        self.with_name_is_not("Finished")
    }


    pub fn name_is_postponed(self) -> Self {
        self.with_name_is("Postponed")
    }

    pub fn with_name_is_postponed(self) -> Self {
        self.with_name_is("Postponed")
    }



    pub fn with_name_is_not_postponed(self) -> Self {
        self.with_name_is_not("Postponed")
    }
    ...
    pub fn code_is_liv_e(self) -> Self {
        self.with_code_is("LIVE")
    }

    pub fn with_code_is_liv_e(self) -> Self {
        self.with_code_is("LIVE")
    }



    pub fn with_code_is_not_liv_e(self) -> Self {
        self.with_code_is_not("LIVE")
    }


    pub fn code_is_finishe_d(self) -> Self {
        self.with_code_is("FINISHED")
    }

    pub fn with_code_is_finishe_d(self) -> Self {
        self.with_code_is("FINISHED")
    }



    pub fn with_code_is_not_finishe_d(self) -> Self {
        self.with_code_is_not("FINISHED")
    }


    pub fn code_is_postpone_d(self) -> Self {
        self.with_code_is("POSTPONED")
    }

    pub fn with_code_is_postpone_d(self) -> Self {
        self.with_code_is("POSTPONED")
    }



    pub fn with_code_is_not_postpone_d(self) -> Self {
        self.with_code_is_not("POSTPONED")
    }
...
impl<R> Default for MatchStatusRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< MatchStatusRequest<R> > for SelectQuery {
    fn from(request: MatchStatusRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< MatchStatusRequest<R> > for QuerySelection {
    fn from(request: MatchStatusRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::MatchStatus> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlRepositoryError<C::MatchStatusRepository<'a>>;
    fn save(self, ctx: &'a C) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<teaql_runtime::GraphNode, Self::Error>> + '_>> {
        Box::pin(async move { self.into_entity().save(ctx).await })
    }
}

impl<R: teaql_core::Entity> crate::PurposedQuery<MatchStatusRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::MatchStatus
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::MatchStatus::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> MatchStatusRequest<R> {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlRepositoryError<C::MatchStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
