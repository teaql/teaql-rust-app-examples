...
#[teaql(entity = "GoalCategory", table = "goal_category_data", data_service = "sqlite")]
...
#[teaql(relation(target = "MatchGoal", local_key = "id", foreign_key = "goal_category_id", many))]
...
impl GoalCategory {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("GoalCategory", self.id)
    }
    ...
    pub(crate) async fn save<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<teaql_runtime::GraphNode, crate::TeaqlRepositoryError<C::GoalCategoryRepository<'a>>>
    where
