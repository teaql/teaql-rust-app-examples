...
impl EntityReference for crate::MatchCard {
...
#[derive(Debug)]
pub struct MatchCardRequest<R = crate::MatchCard> {
    query: SelectQuery,
...
impl<R> Clone for MatchCardRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> MatchCardRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("MatchCard"),
    ...
    pub fn return_type<T>(self) -> MatchCardRequest<T> {
        MatchCardRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| RepositoryError::Runtime(RuntimeError::Graph(format!("count result for MatchCard is missing or not numeric"))))
    }

    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    fn dynamic_json_self_field(field: &str) -> Option<&'static str> {
        match field {
            ...
            "minute_issued" => Some("minute_issued"),
            ...
            "card_category" | "card_category_id" => Some("card_category_id"),
    ...
    fn apply_dynamic_json_chain_filter(self, head: &str, tail: &str, value: &JsonValue) -> Self {
        ...
        match head {
            ...
            "card_category" => {
                self.with_card_category_matching(
    ...
    pub fn select_all(self) -> Self {
        ...
        request = request.select_card_category();
    ...
    pub fn select_minute_issued(mut self) -> Self {
        self.query = self.query.project("minute_issued");
        self
    }

    pub fn project_minute_issued(self) -> Self {
        self.select_minute_issued()
    }

    pub fn select_minute_issued_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_minute_issued_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_minute_issued_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("minute_issued", raw_sql_segment));
        self
    }

    pub fn select_minute_issued_with_function(self, function: AggregateFunction) -> Self {
        self.select_minute_issued_as_with_function("minute_issued", function)
    }

    pub fn select_minute_issued_as_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.aggregate_with_function("minute_issued", alias, function)
    }

    pub fn group_by_minute_issued(self) -> Self {
        self.group_by("minute_issued")
    }

    pub fn group_by_minute_issued_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("minute_issued");
        request.query = request
            .query
            .project_expr(alias, Expr::column("minute_issued"));
        request
    }

    pub fn group_by_minute_issued_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("minute_issued")
            .aggregate_with_function("minute_issued", alias, function)
    }

    pub fn count_minute_issued(self) -> Self {
        self.count_minute_issued_as("minute_issued_count")
    }

    pub fn count_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("minute_issued", alias)
    }

    pub fn sum_minute_issued(self) -> Self {
        self.sum_minute_issued_as("sum_minute_issued")
    }

    pub fn sum_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("minute_issued", alias)
    }

    pub fn avg_minute_issued(self) -> Self {
        self.avg_minute_issued_as("avg_minute_issued")
    }

    pub fn avg_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("minute_issued", alias)
    }

    pub fn min_minute_issued(self) -> Self {
        self.min_minute_issued_as("min_minute_issued")
    }

    pub fn min_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("minute_issued", alias)
    }

    pub fn max_minute_issued(self) -> Self {
        self.max_minute_issued_as("max_minute_issued")
    }

    pub fn max_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("minute_issued", alias)
    }

    pub fn standard_deviation_minute_issued(self) -> Self {
        self.standard_deviation_minute_issued_as("stdDev_minute_issued")
    }

    pub fn standard_deviation_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev("minute_issued", alias)
    }

    pub fn square_root_of_population_standard_deviation_minute_issued(self) -> Self {
        self.square_root_of_population_standard_deviation_minute_issued_as("stdDevPop_minute_issued")
    }

    pub fn square_root_of_population_standard_deviation_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev_pop("minute_issued", alias)
    }

    pub fn sample_variance_minute_issued(self) -> Self {
        self.sample_variance_minute_issued_as("varSamp_minute_issued")
    }

    pub fn sample_variance_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_samp("minute_issued", alias)
    }

    pub fn sample_population_variance_minute_issued(self) -> Self {
        self.sample_population_variance_minute_issued_as("varPop_minute_issued")
    }

    pub fn sample_population_variance_minute_issued_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_pop("minute_issued", alias)
    }

    pub fn unselect_minute_issued(mut self) -> Self {
        self.query.projection.retain(|field| field != "minute_issued");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "minute_issued");
        self
    }


    pub fn with_minute_issued(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_minute_issued_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_minute_issued_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("minute_issued", value));
        self
    }



    pub fn with_minute_issued_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("minute_issued", value));
        self
    }

    pub fn with_minute_issued_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("minute_issued", value));
        self
    }

    pub fn with_minute_issued_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("minute_issued", value));
        self
    }

    pub fn with_minute_issued_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("minute_issued", value));
        self
    }

    pub fn with_minute_issued_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("minute_issued", value));
        self
    }

    pub fn with_minute_issued_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("minute_issued", lower, upper));
        self
    }

    pub fn with_minute_issued_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_minute_issued_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_minute_issued_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("minute_issued", value));
        self
    }

    pub fn with_minute_issued_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("minute_issued", value));
        self
    }

    pub fn with_minute_issued_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("minute_issued"));
        self
    }



    pub fn with_minute_issued_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("minute_issued"));
        self
    }


    pub fn order_by_minute_issued_asc(mut self) -> Self {
        self.query = self.query.order_asc("minute_issued");
        self
    }

    pub fn order_by_minute_issued_desc(mut self) -> Self {
        self.query = self.query.order_desc("minute_issued");
        self
    }

    pub fn order_by_minute_issued_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("minute_issued");
        self
    }

    pub fn order_by_minute_issued_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("minute_issued");
        self
    }
    ...
    /// Please use `with_card_category_is` instead
    pub(crate) fn filter_by_card_category(mut self, value: impl EntityReference) -> Self {
        self.query = self.query.and_filter(Expr::eq("card_category_id", value.entity_id_value()));
        self
    }
    /// Complex relation filter for `card_category`.
    ///
    /// **Usage Priority:**
    ///
    ...
    ///    - [`Self::with_card_category_is_xxx`]
    ///
    ...
    /// let dynamic_query = crate::Q::card_categories_minimal().filter(...);
    /// let request = crate::Q::match_cards().with_card_category_matching(dynamic_query);
    /// ```
    pub fn with_card_category_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::in_subquery(
            "card_category_id",
        ...
        self.relation_filters.push(RelationFilter::new("card_category", selection));
        self
    }
    ...
    ///
    /// 1. **Preferred**: If you only want to filter by specific known constants, please **prefer** the generated semantic shortcut methods, such as:
    ///    - [`Self::with_card_category_is_not_xxx`]
    ///
    ///    This gives the best code readability.
    ///
    /// 2. **Advanced**: Only use this method when you need to perform advanced searches, dynamic subqueries, or filter based on complex relation conditions.
    ...
    /// // Only use when building dynamic queries
    /// let dynamic_query = crate::Q::card_categories_minimal().filter(...);
    /// let request = crate::Q::match_cards().without_card_category_matching(dynamic_query);
    /// ```
    pub fn without_card_category_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::not_in_subquery(
            "card_category_id",
            <crate::CardCategory as teaql_core::TeaqlEntity>::entity_descriptor(),
    ...
    pub fn have_card_category(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("card_category_id"));
        self
    }

    pub fn have_no_card_category(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("card_category_id"));
        self
    }


    pub fn group_by_card_category(self) -> Self {
        self.group_by("card_category_id")
    }

    pub fn group_by_card_category_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("card_category_id");
        request.query = request
            .query
            .project_expr(alias, Expr::column("card_category_id"));
        request
    }

    pub fn group_by_card_category_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("card_category_id")
            .aggregate_with_function("card_category_id", alias, function)
    }

    pub fn group_by_card_category_with(mut self, request: impl Into<QuerySelection>) -> Self {
        self.query = self.query.group_by("card_category_id");
        self.query_options.object_group_bys.push(ObjectGroupBy::new(
            "card_category",
            "card_category_id",
            request,
    ...
    pub fn group_by_card_category_with_details(self) -> Self {
        self.group_by_card_category_with_details_from(crate::Q::card_categories().unlimited())
    }

    pub fn group_by_card_category_with_details_from(self, request: impl Into<QuerySelection>) -> Self {
        self.group_by_card_category_with(request)
    }


    pub fn roll_up_to_card_category(self) -> Self {
        self.roll_up_to_card_category_with(crate::Q::card_categories().unlimited())
    }

    pub fn roll_up_to_card_category_with(self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.with_card_category_matching(selection.clone())
            .group_by_card_category_with(selection)
    }

    pub fn count_card_category(self) -> Self {
        self.count_card_category_as("card_category_count")
    }

    pub fn count_card_category_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("card_category_id", alias)
    }

    pub fn unselect_card_category(mut self) -> Self {
        self.query.projection.retain(|field| field != "card_category_id");
        self.query.relations.retain(|relation| relation.name != "card_category");
        self
    }
    ...
    pub fn card_category_is_yellow(self) -> Self {
        self.filter_by_card_category(1001_u64)
    }

    pub fn with_card_category_is_yellow(self) -> Self {
        self.filter_by_card_category(1001_u64)
    }



    pub fn with_card_category_is_not_yellow(mut self) -> Self {
        self.query = self.query.and_filter(Expr::ne("card_category_id", 1001_u64));
        self
    }


    pub fn card_category_is_red(self) -> Self {
        self.filter_by_card_category(1002_u64)
    }

    pub fn with_card_category_is_red(self) -> Self {
        self.filter_by_card_category(1002_u64)
    }



    pub fn with_card_category_is_not_red(mut self) -> Self {
        self.query = self.query.and_filter(Expr::ne("card_category_id", 1002_u64));
        self
    }


    pub fn card_category_is_second_yellow(self) -> Self {
        self.filter_by_card_category(1003_u64)
    }

    pub fn with_card_category_is_second_yellow(self) -> Self {
        self.filter_by_card_category(1003_u64)
    }



    pub fn with_card_category_is_not_second_yellow(mut self) -> Self {
        self.query = self.query.and_filter(Expr::ne("card_category_id", 1003_u64));
        self
    }
    ...
    pub fn select_card_category(mut self) -> Self {
        self.query = self.query.relation("card_category");
        self
    }

    pub fn select_card_category_with(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.relation_query("card_category", selection.clone().into_query());
        self.relation_selections.push(RelationSelection::new("card_category", selection));
        self
}

    pub fn facet_by_card_category_as(self, facet_name: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.facet_by_card_category_as_with_options(facet_name, request, true)
    }

    pub fn facet_by_card_category_as_with_options(
        mut self,
        facet_name: impl Into<String>,
        request: impl Into<QuerySelection>,
        include_all_facets: bool,
...
impl<R> Default for MatchCardRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< MatchCardRequest<R> > for SelectQuery {
    fn from(request: MatchCardRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< MatchCardRequest<R> > for QuerySelection {
    fn from(request: MatchCardRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::MatchCard> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlRepositoryError<C::MatchCardRepository<'a>>;
    fn save(self, ctx: &'a C) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<teaql_runtime::GraphNode, Self::Error>> + '_>> {
        Box::pin(async move { self.into_entity().save(ctx).await })
    }
}

impl<R: teaql_core::Entity> crate::PurposedQuery<MatchCardRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::MatchCard
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::MatchCard::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> MatchCardRequest<R> {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlRepositoryError<C::MatchCardRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
